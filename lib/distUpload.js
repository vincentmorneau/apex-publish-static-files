...
for (var file in files) {
	...
	var plsql =
		...
		"   select workspace_id, theme_number" +
		"   into l_workspace_id, l_theme_id" +
		...
		"   end loop;" +
		// inserts the file
		"   execute immediate 'alter session set current_schema=' || l_apex_schema;" +
		"   " + createFileAPI +
		"   exception when no_data_found then" +
		"      dbms_output.put_line('Application ID ' || l_app_id || ' is not valid.');" +
		" end;";
